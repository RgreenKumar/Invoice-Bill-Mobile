...
//            assigned:true,
//          }))
//          const response = await axios.get(`${baseUrl}/Trainer/GetBatches/${userId}?page=${page}&size=${size}`,{
//            headers:{
//              Authorization:token
//            }
//          });
...
//          other:true,
//          }))
//          const response = await axios.get(`${baseUrl}/Trainer/getOtherbatches/${userId}?page=${page}&size=${size}`,{
//            headers:{
//              Authorization:token
//            }
//          });
...
//              `${baseUrl}/Trainer/AssignCourse/Batch`,
//              {},
//              {
//                  headers: {
//                      Authorization: token,
...
//                    </li>
//                    <li className="breadcrumb-item">
//                      <a href="#" onClick={()=>{navigate("/view/Trainer")}}>
//                        {" "}
...
//      </div>
//    ) : !submitting.assigned ? (
//     <div className='w-100 align-center'> <small className="text-muted ">No Batches Assigned</small></div>
//    ) : null}
