...
final List<_RouteEntry> _routes = [
  ...
  // Settings
  _RouteEntry('/settings/Weightage', (c, s) => _placeholder('Weightage Setting', 'UserSettings/WeightageSetting.js'), const _Guard(authenticationRequired: true, onlyAdmin: true)),
  _RouteEntry('/settings/mailSettings', (c, s) => _placeholder('Mail Settings', 'UserSettings/MailSettings.js'), const _Guard(authenticationRequired: true, onlyAdmin: true)),
  _RouteEntry('/settings/footer', (c, s) => _placeholder('Footer Details', 'UserSettings/FooterDetails.js'), const _Guard(authenticationRequired: true, onlyAdmin: true)),
  _RouteEntry('/settings/displayname', (c, s) => _placeholder('Display Name', 'UserSettings/DisplayName.js'), const _Guard(authenticationRequired: true, authorizationRequired: true, onlyAdmin: true)),
  _RouteEntry('/settings/viewsettings', (c, s) => _placeholder('View Settings', 'UserSettings/SettingsComponent.js'), const _Guard(authorizationRequired: true, onlyAdmin: true)),
  _RouteEntry('/settings', (c, s) => _placeholder('User Settings', 'UserSettings/UserCommonSetting.js'), const _Guard(authenticationRequired: true, onlyUser: true)),
  _RouteEntry('/settings/taxes&gstpage', (c, s) => _placeholder('Taxes & GST', 'UserSettings/TaxesGST.js'), const _Guard(authenticationRequired: true, authorizationRequired: true)),
  _RouteEntry('/settings/Items', (c, s) => _placeholder('Item Settings', 'UserSettings/Itemsettings.js'), const _Guard(authenticationRequired: true, authorizationRequired: true)),
  _RouteEntry('/settings/users', (c, s) => _placeholder('Manage Users', 'UserSettings/ManageUsers.js'), const _Guard(authenticationRequired: true, authorizationRequired: true)),
  _RouteEntry('/addusers', (c, s) => _placeholder('Add User', 'UserSettings/AddUsers.js'), const _Guard(authenticationRequired: true, authorizationRequired: true)),
