...
class MainLayout extends StatefulWidget {
  ...
  final VoidCallback? onNavigateParties;

  const MainLayout({
    super.key,
    this.onNavigateDashboard,
    this.onNavigateParties,
  });
...
class _MainLayoutState extends State<MainLayout> {
  ...
  Widget _sidebarSubItem(String title, bool isSelected, VoidCallback onTap) =>
      Container(
