...
class _CreateEstimateScreenState extends State<CreateEstimateScreen> {
  ...
  Widget estimateTable(AppFeatureSettings settings) {
    return Table(
  ...
  Widget totals(AppFeatureSettings settings) {
    return Align(
