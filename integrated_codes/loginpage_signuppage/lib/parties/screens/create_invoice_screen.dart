...
class _CreateInvoiceScreenState extends State<CreateInvoiceScreen> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: textField("Due Date", _dueDateController),
                        ),
  ...
  Widget invoiceTable(AppFeatureSettings settings) {
    return Table(
      ...
      children: [
        TableRow(
          ...
          children: [
            const TableHeading("Item"),

            const TableHeading("Qty"),

            const TableHeading("Price"),

            if (settings.enableGst) const TableHeading("GST"),

            if (settings.itemWiseDiscount) const TableHeading("Discount"),

            const TableHeading("Amount"),
          ],
        ),
        ...
        ...items.map(
          (e) => TableRow(
            children: [
              ...
              if (settings.enableGst) tableField(),

              if (settings.itemWiseDiscount) tableField(),
  ...
  Widget totalsSection(AppFeatureSettings settings) {
    return Align(
      ...
      child: SizedBox(
        ...
        child: Column(
          children: [
            ...
            if (settings.enableGst) totalRow("GST", "₹ 0"),

            if (settings.itemWiseDiscount) totalRow("Discount", "₹ 0"),
