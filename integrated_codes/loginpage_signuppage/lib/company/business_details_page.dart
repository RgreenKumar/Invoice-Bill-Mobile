...
class _BusinessDetailsColumn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const _FormColumn(
      ...
      children: [
        _CustomTextField(label: 'Business Name *', hintText: 'Enter Business Name'),
        _CustomTextField(label: 'Phone Number', hintText: 'Enter Phone Number'),
        _CustomTextField(label: 'GSTIN', hintText: 'Enter GSTIN'),
        _CustomTextField(label: 'Email ID', hintText: 'Enter Email ID'),
      ],
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return const _FormColumn(
      ...
      children: [
        ...
        _CustomTextField(label: 'Pincode', hintText: 'Enter Pincode'),
      ],
    );
  }
}
