...
class _ViewStudentListScreenState extends State<ViewStudentListScreen> {
  ...
  Future<void> _fetchCustomers() async {
    ...
    try {
      ...
      // opening "Customers" always jumped straight into whichever
      // customer happened to be first, hiding the actual customer list -
      // reported as "it's automatically selecting the first customer".
      // The person now always lands on the list and taps to select.
    } catch (e) {
              ...
              if (isWide)
                Row(
                  ...
                  children: [
                    ...
                    // NOTE: no "Edit customer" action here - the source
                    // React app (Student/AddCustomer.js) never supported
