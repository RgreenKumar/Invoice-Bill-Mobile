...
final List<_RouteEntry> _routes = [
  ...
  // NOTE: `/view/POSform` (Sales/InvoicePOS.js) removed per explicit
  // request. `Modules.invoicePos` permission tracking and the
  // `billTypes=SALE,POS` filter / "POS" badge in the Sales list are left
  // intact - those aren't the standalone POS page, they're what lets the
  // Sales list still correctly show/filter any historical bills that
  // were created with that bill type.
