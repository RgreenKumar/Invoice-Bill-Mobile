    ...
    final name = await showDialog<String>(
      ...
      builder: (dialogCtx) => AlertDialog(
        ...
        actions: [
          ...
          FilledButton(onPressed: () => Navigator.pop(dialogCtx, controller.text), child: const Text('Create')),
        ],
      ),
    );
  ...
  Future<void> _handleEditCategory(Map<String, dynamic> item) async {
    ...
    final name = await showDialog<String>(
      ...
      builder: (dialogCtx) => AlertDialog(
        ...
        actions: [
          TextButton(onPressed: () => Navigator.pop(dialogCtx), child: const Text('Cancel')),
          FilledButton(onPressed: () => Navigator.pop(dialogCtx, controller.text), child: const Text('Update')),
        ],
      ),
    );
    if (name == null || name.trim().isEmpty) return;
