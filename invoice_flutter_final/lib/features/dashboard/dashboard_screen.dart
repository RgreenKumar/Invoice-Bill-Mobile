...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget _adminBody(BuildContext context, IconData currencyIcon, Map<String, dynamic> displayname) {
    return Column(
      ...
      children: [
        _kpiStrip(context, [
          _Kpi(Icons.menu_book, Colors.amber, '${_countDetails['coursecount'] ?? 0}', 'Total Items',
          ...
          _Kpi(Icons.people, Colors.red, '${_countDetails['usercount'] ?? 0}',
              (displayname['student_name'] as String?)?.isNotEmpty == true
                  ? displayname['student_name'] : 'Customers',
          ...
          _Kpi(Icons.verified_user, Colors.blueGrey, '${_countDetails['trainercount'] ?? 0}',
              (displayname['trainer_name'] as String?)?.isNotEmpty == true
                  ? displayname['trainer_name'] : 'Suppliers',
        ...
        _card(
          context,
          title: 'Parties',
          subtitle: 'Active supplier overview',
          action: TextButton(onPressed: () => context.go('/view/Trainer'), child: const Text('View all')),
          child: _table(['Name', 'Paid', 'Free', 'Customers'], _trainerFest.map((t) => [
        ...
        _card(
          ...
          title: (displayname['student_name'] as String?)?.isNotEmpty == true
              ? displayname['student_name'] as String : 'Customers',
  ...
  Widget _sysAdminBody(BuildContext context, IconData currencyIcon) {
    return Column(
      ...
      children: [
        _kpiStrip(context, [
          _Kpi(Icons.menu_book, Colors.amber, '${_countDetails['coursecount'] ?? 0}', 'Items'),
          _Kpi(Icons.people, Colors.red, '${_countDetails['usercount'] ?? 0}', 'Customers'),
          _Kpi(Icons.verified_user, Colors.blueGrey, '${_countDetails['trainercount'] ?? 0}', 'Suppliers'),
        ...
        _card(
          ...
          child: _table(['Name', 'Batch', 'Item', 'Amount'], _studentFestSysAdmin.map((s) => [
